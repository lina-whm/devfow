                  ...
                  <div className="flex items-center gap-3">
                    <Avatar className="h-8 w-8">
                      ...
                      <AvatarFallback className="text-xs">
                        {task.assignee.displayName.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2)}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                      <p className="text-sm font-medium">{task.assignee.displayName}</p>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <Avatar className="h-8 w-8">
                    ...
                    <AvatarFallback className="text-xs">
                      {task.reporter.displayName.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2)}
                    </AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="text-sm font-medium">{task.reporter.displayName}</p>
            ...
            comments.map((comment) => (
              <div key={comment.id} className="flex gap-3">
                <Avatar className="h-8 w-8 shrink-0">
                  ...
                  <AvatarFallback className="text-xs">
                    {comment.user.displayName.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2)}
                  </AvatarFallback>
                </Avatar>
